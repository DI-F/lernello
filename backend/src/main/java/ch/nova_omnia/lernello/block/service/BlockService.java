...
import ch.nova_omnia.lernello.block.dto.request.blockActions.AddBlockActionDTO;
import ch.nova_omnia.lernello.block.dto.request.blockActions.BlockActionDTO;
import ch.nova_omnia.lernello.block.dto.request.blockActions.RemoveBlockActionDTO;
import ch.nova_omnia.lernello.block.dto.request.blockActions.ReorderBlockActionDTO;
import ch.nova_omnia.lernello.block.dto.request.blockActions.UpdateBlockActionDTO;
import ch.nova_omnia.lernello.block.dto.request.blockActions.UpdateBlockNameActionDTO;
...
public class BlockService {
    ...
    private void removeBlock(LearningUnit learningUnit, RemoveBlockActionDTO removeAction) {
        ...
        List<BlockStatistic> associatedStatistices = blockStatisticRepository.findByBlock_Uuid(blockUuid);
        blockStatisticRepository.deleteAll(associatedStatistices);
