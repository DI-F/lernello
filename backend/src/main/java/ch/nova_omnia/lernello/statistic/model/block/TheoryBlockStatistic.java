...
public class TheoryBlockStatistic extends BlockStatistic {
    ...
    public TheoryBlockStatistic(User user, TheoryBlock block, LearningUnitProgress unitProgress) {
        super(user, block, unitProgress);
    }

    public TheoryBlockStatistic(User user, TheoryBlock block, Boolean isViewed, LearningUnitProgress unitProgress) {
        super(user, block, unitProgress);
